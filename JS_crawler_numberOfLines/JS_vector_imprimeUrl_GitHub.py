...
with open('../Files/JS_projects.csv', 'r') as projects_file:
...
with open('../Files/commits.csv', 'r') as commits_file:
	...
	with open('vector_url_commits_projects.csv', 'a') as w:
		...
		for row in data:
			...
			if(projects[commit_project_id] != 0): #só os projetos de JavaScript serão impressos
